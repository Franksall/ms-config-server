package com.example.ms_config_server; // (Asegúrate que el package sea el tuyo)
...
class MsConfigServerApplicationTests {
    ...
    void main() {
        ...
        try (MockedStatic<SpringApplication> mocked = mockStatic(SpringApplication.class)) {
            ...
            // (¡Si tu clase principal se llama diferente, cámbialo aquí!)
            MsConfigServerApplication.main(new String[] {});

            // 3. Verificamos que 'SpringApplication.run' fue llamado 1 vez
            mocked.verify(() -> SpringApplication.run(MsConfigServerApplication.class, new String[] {}), times(1));
        }
    }
